...
--[[
  ...
  5.
	default:tiled_brick_monochrome
	default:tiled_brick_blue
	default:tiled_brick_cyan
	default:tiled_brick_grey
	default:tiled_brick_light_blue

  6.
	default:quarter_green
	default:quarter_red
	default:quarter_cyan
	default:quarter_white
...
-- 2. Stripes, stripes block with surface
--Stripes
...
minetest.register_node("default:stripes_surface", {
	...
	tiles = {"default_stripes.png", "default_stripes.png",
			"default_stripes_surface.png", "default_stripes_surface.png",
			"default_stripes_surface.png", "default_stripes_surface.png",
	},
	paramtype2 = "facedir",
	is_ground_content = false,
...
minetest.register_node("default:random_drop", {
	...
	on_punch = function(pos, node, puncher, pointed_thing)
		...
		if nb and nb > 1 then
			...
			minetest.set_node(pos, {name= "default:random_drop_empty"})
		end
...
minetest.register_node("default:random_drop_empty", {
	description = "Random Drop Empty",
	tiles = {"default_surprise_node_top.png"},
	drop = {},
	groups = {unbreakable=1},
	sounds = default.node_sound_stone_defaults(),
})
